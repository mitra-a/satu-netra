...
export const SatuNetra = (value , key, stop = false) => {
    ...
    const fn = {
        ...
        'StartBotSelectHipnoterapi' : function(){
            let SELECT = ['hipnoterapi','hypnotherapy','musik'];
            ...
            if(selectCheck){
                return {
                    ...
                    next : 'close',
                    previous : key,
                    selectedMusic : value == 'hipnoterapi' || value == 'hypnotherapy' ? 'hipnoterapi' : 'music'
                }
            }
